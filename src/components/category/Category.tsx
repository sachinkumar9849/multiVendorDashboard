                ...
                <div className="mb-8 ">
                  ...
                  <ImageComponent/>
                        ...
                        <div className="flex justify-end mt-3 gap-3">
                            ...
                            <button className="px-6 py-2 bgBlue text-white rounded-lg font-medium transition-colors">
                                Submit
                            </button>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div className=" flex flex-col md:flex-row gap-4 justify-between items-start md:items-center p-6">
                       <div className="flex gap-3">
                          <p className='text-xl font-semibold text-gray-900'>Category list</p>
                          <p className='badge text-dark bg-body-secondary fw-semibold rounded-50'>18</p>
                        </div>
                            ...
                            <table className="w-full">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Category Image</th>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Name</th>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Priority</th>
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Home category status</th>
